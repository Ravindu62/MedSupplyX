    ...
    <div class="content">
        ...
        <div class="anim">
            <div class="container-fluid">
                <div class="d-flex">
                    <form action="<?php echo URLROOT; ?>/pharmacies/rejectBid/<?php echo $acceptedOrderDetails->id ?>" method="post">
                        <table>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td> : </td>
                                <td class="verticleCentered">
                                    <p class="detailText"> <?php echo $acceptedOrderDetails->reply; ?> </p>
                                </td>
                            </tr>
