...
<body>
  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <!-- <div class="column">
        <div class="card1">
          ...
          <a class="dashboard-a" href="<?php echo URLROOT; ?>/pharmacies/todaysCustomerOrders"> Todays Customer Orders </a>
        </div>
      </div>
      ...
      <div class="column">
        <div class="card1">
          ...
          <a class="dashboard-a" href=""> Bill count </a>
        </div>
      </div>
    ...
    $chartData = [
      ...
      $data['countTodaysCustomerOrders'],
      $data['countBills'],
      $data['countOutOfStockProducts']
    ];
