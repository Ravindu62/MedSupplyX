...
<body>
    ...
    <div class="content">
        ...
        <div class="anim">
            <h2> Reduce Stock of <?php echo $inventory->name ?> </h2>
        </div>
        ...
        <div class="anim">
            <div class="container-fluid">
                <div class="d-flex">
                    <form action="<?php echo URLROOT; ?>/pharmacies/reduceInventory/<?php echo $inventory->id ?>" method="POST">
                        <table>
                            ...
                            <tr>
                                ...
                                <td> : </td>
                                <td class="verticleCentered"> <input type="number" class="smallForm" min="1" value="<?php echo $inventory->quantity ?>" disabled> </td>
                            ...
                            <tr>
                                <td><input type="submit" value="Reduce" class="publicbtn"></td>
