...
<head>
    <title> Your Rejected Order Medicines by Brand </title>
    <meta charset="utf-8">
...
<body>
    ...
    <h2>
      ...
      <div class="alignRight">
        ...
        <div class="anim">
            <h2> Rejected Order by You (Medicines Brand)</h2>
        </div>
        <div class="smallspace"></div>
        ...
        <div class="anim">
            ...
            <table class="customers">
                ...
                <?php foreach ($data['orderDetails'] as $pharmacyRejectedOrders) : ?>
                    <tr onclick=window.location.href='<?php echo URLROOT; ?>/pharmacies/showPharmacyRejectedOrderDetails/<?php echo $pharmacyRejectedOrders->id; ?>'>
                        <td> <?php echo date('Y-m-d', strtotime($pharmacyRejectedOrders->orderedDate)); ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->medicineName; ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->brand; ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->supplierName; ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->volume . ' ' . $pharmacyRejectedOrders->type; ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->category ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->quantity; ?> </td>
                        <td> <?php echo $pharmacyRejectedOrders->bidAmount; ?> </td>
                    </tr>
                <?php endforeach; ?>
