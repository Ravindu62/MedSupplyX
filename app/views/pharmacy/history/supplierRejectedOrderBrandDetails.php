...
<head>
    <title> Supplier Rejected Order Medicines Brand </title>
    <meta charset="utf-8">
...
<body>
    ...
    <h2>
      ...
      <div class="alignRight">
        ...
        <div class="anim">
            <h2> Supplier Rejected Order (Medicines Brand)</h2>
        </div>
        <div class="smallspace"></div>
        ...
        <div class="anim">
            ...
            <table class="customers">
                ...
                <?php foreach ($data['orderDetails'] as $supplierRejectedOrders) : ?>
                    <tr onclick=window.location.href='<?php echo URLROOT; ?>/pharmacies/showSupplierRejectedOrderDetails/<?php echo $supplierRejectedOrders->id; ?>'>
                        <td> <?php echo date('Y-m-d', strtotime($supplierRejectedOrders->orderedDate)); ?> </td>
                        <td> <?php echo $supplierRejectedOrders->medicineName; ?> </td>
                        <td> <?php echo $supplierRejectedOrders->brand; ?> </td>
                        <td> <?php echo $supplierRejectedOrders->supplierName; ?> </td>
                        <td> <?php echo $supplierRejectedOrders->volume . ' ' . $supplierRejectedOrders->type; ?> </td>
                        <td> <?php echo $supplierRejectedOrders->category ?> </td>
                        <td> <?php echo $supplierRejectedOrders->quantity; ?> </td>
                        <td> <?php echo $supplierRejectedOrders->bidAmount; ?> </td>
                    </tr>
                <?php endforeach; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            startEvent(null, 'supplierRejectedOrders');
        });
