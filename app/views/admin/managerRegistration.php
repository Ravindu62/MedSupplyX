...
<div class="d-flex">
  <form action="<?php echo URLROOT; ?>/admins/managerRegistration" method="post" class="form-group">
    ...
    <tr> <td class="verticleCentered"> 
      ...
      <td> : </td>
         <td class="verticleCentered" colspan="3"> <input type="text" name="mphone" class="orderdetails" pattern="[0-9]{10}" title="Please enter valid phone number" placeholder="07xxxxxxxx"
