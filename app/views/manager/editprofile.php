        ...
        <div class="profilecard">
            <div class="card-body">
                ...
                <table>
                        ...
                        <tr>
                            <td> <p class="profdetails"> Old Password </p> </td>
                            <td> : </td>
                            <td colspan="2">  
                            <input id="oldpassword" type="password" value="<?php echo $data['getUserData']->password; ?>" class="orderdetails">  </td>
                        ...
                        <tr>
                            ...
                            <td> : </td>
                            <td colspan="2">  
                            <input id="newpassword" type="password" class="orderdetails">  </td>
                            <td> <input type="checkbox" onclick="showPassword2()"> show password </td>
                            
                        </tr>
                        <tr>
                            <td> <button class="addBtn"> Accept </button> </td> </td>
                        </tr>
