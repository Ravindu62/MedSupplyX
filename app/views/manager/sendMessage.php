...
<div class="content">
  ...
  <div class="anim">
    <div class="container-fluid">
      <div class="d-flex">
        <form action="<?php echo URLROOT; ?>/managers/sendMessage/<?php echo $getMessageData->id; ?>" method="post">
          <table>
            <tr>
              <td colspan="2">
                <h3> <br> <br> Message </h3>
            ...
            <input type="hidden" name="heading" value="<?php echo $getMessageData->heading ?>">
              <td class="verticleCentered" colspan="4"> <input class="addBtn2" type="submit" value="Send Message">
