...
<section class="home">
    ...
    <div class="login">
        ...
        <form action="<?php echo URLROOT; ?>/users/adminlogin" method="post">
            <div class="input">
                <input class="input1" type="email" name="email" <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?> value="<?php echo $data['email']; ?>">
                <span> <?php echo $data['email_err']; ?> </span>
                <i class="fa-solid fa-envelope"></i>
            </div>
            <div class="input">
                <input class="input1" type="password" name="password" <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?> value="<?php echo $data['password']; ?>">
