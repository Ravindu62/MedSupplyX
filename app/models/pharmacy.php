...
class pharmacy
{
    ...
    public function submitOrder($data){
        $this->db->query('INSERT INTO requestorder (pharmacy_id, pharmacyname, medicine_id, medicine_name, batchno, type, volume, category, quantity, brand, deliveryDate) VALUES(:pharmacy_id, :pharmacyname , :medicine_id, :medicine_name, :batchno, :type, :volume, :category, :quantity, :brand, :deliveryDate)');
        // Bind values
